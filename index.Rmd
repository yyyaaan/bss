...
\\ &= & \boldsymbol z_t & \boldsymbol\Omega'(1+t \boldsymbol{\mathcal E})'
\end{aligned}$$

Key assumputions: uncorrelated, zero-mean, independence of parameters, stationary.
...
= \underbrace {\begin{bmatrix} 1 & 1 & 1^2+l & l \\  1 & 2 & 2^2+l & l \\ \vdots &\vdots &\vdots &\vdots \\  1 & T-l & (T-l)^2+l & l \end{bmatrix}} _ {:= \mathbf H}  
\underbrace {\begin{bmatrix} \boldsymbol R_l \ [i,j] \\ ({\boldsymbol{\mathcal E}\, \boldsymbol R_l + \boldsymbol R_l \, \boldsymbol{\mathcal E}'})\ [i,j]\\ ({ \boldsymbol{\mathcal E}\, \boldsymbol R_l \, \boldsymbol{\mathcal E}'}) \ [i,j] \\ ({\boldsymbol R_l \, \boldsymbol{\mathcal E}'}) \ [i,j] \end{bmatrix}} _ {:= \boldsymbol \beta}
$$
