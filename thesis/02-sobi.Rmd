...
The ambiguity can be summarised mathematically as $\boldsymbol\Gamma = \boldsymbol{C \Omega}^{-1}$, where the matrix $\boldsymbol C \in \mathcal C$, a set of matrices that contain exactly one non-zero element in each row and column.
