...
The high dimension ($lp^2 \times p^2$) of the first matrix in the right hand side in \@ref(eq:solveepsion) should be well-awared, and for major computer platform, linear estimation is faster and more reliable compared with inversion.