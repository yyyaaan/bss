...
|  | I | II | III | IV |
|---------------------------|--------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|
| $\boldsymbol{\mathcal E}$ | $\begin{bmatrix} -3 & 6 & -6 \\ -4 &2.5 & 6\\ 9&2.1 &7 \end{bmatrix} \times 10^{-5}$ | $\begin{bmatrix} -3 & 6 & -6 \\ -4 &2.5 & 6\\ 9&2.1 &7 \end{bmatrix} \times 10^{-4}$ | $\begin{bmatrix} -3 & 6 & -6 \\ -4 &2.5 & 6\\ 9&2.1 &7 \end{bmatrix} \times 10^{-5}$ | $\begin{bmatrix} -3 & 6 & -6 \\ -4 &2.5 & 6\\ 9&2.1 &7 \end{bmatrix} \times 10^{-4}$ |
| Simulated Total Length | $100000\ (10^5)$ | $100000\ (10^5)$ | $10000\ (10^4)$ | $10000\ (10^4)$ |
| Sampling Frequency | $1:1\\ 2:1\\ 4:1\\ \vdots\\ 1024:1$ | $1:1\\ 2:1\\ 4:1\\ \vdots\\ 1024:1$ | $1:1\\ 2:1\\ 4:1\\ \vdots\\ 512:1$ | $1:1\\ 2:1\\ 4:1\\ \vdots\\ 512:1$ |
| Observed Length | $100000\\ 50000\\ 25000\\ \vdots \\ 98$ | $100000\\ 50000\\ 25000\\ \vdots \\ 98$ | $10000\\ 5000\\ 2500\\ \vdots \\ 40$ | $10000\\ 5000\\ 2500\\ \vdots \\ 40$ |


```{r resultA, fig.cap='Simulation Results for Set I and II', out.width='93%', echo = FALSE}
library(tidyverse)
...
```{r resultB, fig.cap='Simulation Results for Set III and IV', out.width='93%', echo = FALSE}
res_sum %>%
