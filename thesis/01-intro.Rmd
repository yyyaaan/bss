...
| $\boldsymbol\Gamma_t$ | unmixing matrix at $t$ | $\boldsymbol\Gamma \overset{\text{def}}= \boldsymbol\Omega^{-1}$ | | $\boldsymbol\Omega$ | mixing matrix at $t=0$ | $\boldsymbol\Omega \overset{\text{def}}= \boldsymbol\Omega_0$ |
