...
Developed from Yeredor [-@yeredor2003tv], this chapter carefully investigates the autocovariance matrices, and introduced new approaches pursuing better mathematical accuracy given TV-SOS model \@ref(eq:tvsobi). Linearly Time Varying Second Order Blind Identification (LTV-SOBI) algorithm mainly includes 3 statistical steps using empirical autocovariance matrices and applying joint diagonalization after applicable decomposition. Various matrix operation is applied in all steps.
