...
where, the underline means that the items will be considered as a whole in later steps and all proceeding chapters.
...
where $\Lambda_{\tau_1}, \dots, \Lambda_{\tau_l}$ are diagonal, and the exact value are unknown. The optimization algrithm only utilizes the property of being diagonal; the values will be available after the optimization, but they are not of interest in TV-SOBI.

After estimating for $\boldsymbol V$, the 
