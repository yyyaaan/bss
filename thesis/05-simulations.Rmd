...
Using tvMD, Figures \@ref(fig:resultC) and \@ref(fig:resultD) demonstrate better performance with lower value, and LTV-SOBI-alt is comparably the best algorithm in most cases except for simulation cohort III; larger observation regularly leads to improved performance. The difference among the three major algorithms is essentially minor.
