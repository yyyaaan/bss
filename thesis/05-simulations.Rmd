...
```{r resultA, fig.cap='Performance measured by tvSIR for Set I and II (the larger the better)', out.width='98%', fig.width = 9, fig.height = 5}
# print(getPlot(4, 90, c("Set I", "Set II"), "tvSIR", c(0,12)))
```

```{r resultB, results='hide', fig.cap='Performance measured by tvSIR for Set III and IV (the larger the better)', out.width='98%', fig.width = 9, fig.height = 5}
...
```{r resultC, fig.cap='Performance measured by tvMD for Set I and II (the smaller the better)', out.width='98%', fig.width = 9, fig.height = 5}
# print(getPlot(2, 90, c("Set I", "Set II"), "tvMD", c(0.8, 1)))
```

```{r resultD, fig.cap='Performance measured by tvMD for Set III and IV (the smaller the better)', out.width='98%', fig.width = 9, fig.height = 5}
