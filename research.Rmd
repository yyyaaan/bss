...
| Experimental Module 2 | performance/accuracy measuring on simulated data in a basic interactive UI                                           | October 2018     | about 50% done                         |
...
| Experimental Module 5 | tensorial JD-TV-SOBI as an unsupervised machine learning; at least "proper vectorization of tensors" will be covered | March-April 2019 |                                        |
| Experimental Module 6 | Trials on dynamic/non-linear time varying mixture;                                                                   | March-April 2019 | failure possible                       |
...
At this moment, the final report shall follow the structure below:
 ...
 2. Second-Order Blind Source Separation and ICA  
  ...
  2.5 Time-Varying Mixture and TV-SOS Model
 ...
 4. Generalization in JD-TV-SOBI  
  ...
  4.2. Tensor-valued Data - Unsupervised Machine Learning Approach
